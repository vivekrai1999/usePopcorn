...
// setting default value for maxstars incase it is not provided
function Starrating({maxStar=5}) {
    ...
    return (
        <div style={starContainerstyle}>
            <div style={starComponentStyle}>
                {Array.from({length: maxStar},(_,i)=><Star key={i} full={tempRating?tempRating>=(i+1):rating>=(i+1)?true:false} onClick={()=>{setRating(i+1)}}
